  ...
  return (
    <div>
      <p className='date-picker'>
        ...
        <span>
          <input type='text' ref={textboxRef} placeholder='e.g. 2020-09-02' id='wpDate' defaultValue='2020-06-24' />

          <button onClick={() => goToDate(textboxRef.current.value)} className='go btn'>
            <FaCalendarCheck />
            <span>Go</span>
          </button>
        </span>
